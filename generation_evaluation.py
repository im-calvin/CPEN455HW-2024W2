...
def my_sample(
    ...
    for label in my_bidict:
        ...
        sample_t = sample(
            model, sample_batch_size, obs, sample_op, class_cond=class_cond
        )
...
if __name__ == "__main__":
    ...
    print(
        "#generated images: {:d}, #reference images: {:d}".format(
    ...
    try:
        ...
        print(
            "Dimension {:d} works! fid score: {}".format(192, fid_score, gen_data_dir)
        )
    except:
